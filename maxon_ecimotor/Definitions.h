...
//Communication
    Initialisation_DllExport HANDLE __stdcall VCS_OpenDevice(const char* DeviceName, const char* ProtocolStackName, const char* InterfaceName, const char* PortName, DWORD* pErrorCode);
